...
KC_TAB,    KC_Q,      KC_W,      KC_E,      KC_R,              U_NA,              TD(U_TD_U_BASE),   TD(U_TD_U_EXTRA),              U_NA,          U_NA,              \
KC_LSFT,   KC_A,      KC_S,      KC_D,      KC_F,              U_NA,              U_NA,              U_NA,             U_NA,      U_NA,   \
KC_LCTL,   KC_Z,      KC_X,      KC_C,      KC_V,              U_NA,              U_NA,              U_NA,             U_NA,      U_NA,\
U_NP,      U_NP,      KC_LALT,    KC_SPC,    KC_M ,             TD(U_TD_U_BASE),  TD(U_TD_U_BASE), TD(U_TD_U_BASE),  U_NP,              U_NP
